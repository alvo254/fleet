...
<div className="admin" class="d-flex">
    ...
    {/* <Sidebar/> */}
      ...
      >
        ...
        >
          <StatBox
          // filter upate successful deliveries
            // title="431,225"
            progress="0.75"
            increase="+75%"
        ...
        >
          <StatBox
          // eka count ya deliveries ziko kwa on transit
            // title="1,325,134"
            subtitle="On Transit"
            progress="0.80"
            increase="+43%"
        ...
        {/* Map the data from the backend ya orders */}
        <Box
          gridColumn="span 4"
          gridRow="span 2"
          backgroundColor={colors.primary[400]}
        ...
        {/* ROW 3 */}
        {/* Usichokoze hii but consider improvements tunaweza make */}
        {/* <Box
          gridColumn="span 4"
          gridRow="span 2"
          backgroundColor={colors.primary[400]}
