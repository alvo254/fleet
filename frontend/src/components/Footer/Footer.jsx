...
<footer class="p-4 mt-36 sm:p-6 dark:bg-gray-900 footerback">
    <div class="md:flex md:justify-between">
        ...
        <div class="grid mx-12 grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div class=''>
                ...
                <h2 class="mb-6 text-sm font-semibold text-white-900 uppercase text-white">Opening Hours</h2>

                <ul class="text-white -600 text-white-400">
                    <li class="mb-4">
                    <p>Monday to Friday - 9am to 9pm</p>
                    </li>
                    <li class="mb-4">
            ...
            <div>
                ...
                <ul class="text-white-600 text-white-400">
                <li class="mb-4">
                <h2 class="mb-6 text-sm font-semibold text-white-900 uppercase text-white">Get In Touch</h2>
                    </li>
                    <li class="mb-4">
                    <p>Nairobi, Kenya<i class="fa fa-map-marker"></i></p>
                    </li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-white-500 sm:text-center text-white-400">© 2022 <a href="https://flowbite.com/" class="hover:underline">QuickFleet™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" class="text-white-500 hover:text-white-900 hover:text-white">
